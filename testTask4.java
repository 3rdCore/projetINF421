...
public class testTask4 {
	public static void main(String[] args) {
		...
		// map en étoile :
		String input = "[(0,0), (1,0), (2,0), (3,0), (4,0), (0,1), (1,1), (2,1), (3,1), (4,1), (0,2), (1,2), (3,2), (4,2), (0,3), (1,3), (2,3), (3,3), (4,3), (0,4), (1,4), (2,4), (3,4), (4,4)]";

		covering CV = new covering(input, 6, 6); // 2 différents constructeur de la classe covering
		...
		for (Polyomino P : CV.Collection) {
			// P.visualize(); // Si l'on souhaite voir tout les placements possibles de
